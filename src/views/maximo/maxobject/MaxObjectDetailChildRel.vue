...
export default {
    ...
    methods: {
        initMainTableParam() {
            return {
                ownerName: `maxrelationship-child`,
                uniqueId: 'relationship-child',
                sksAppName: 'page51',
                ...
                tableColumnList:
                    this.sksUtils.newTableColumnList([
                        ...
                        { prop: 'PARENT', label: '父对象', minWidth: 120 },
                        { prop: 'CHILD', label: '子对象', minWidth: 120, visible: false },
