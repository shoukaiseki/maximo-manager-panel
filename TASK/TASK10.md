...
# 5
加个属性查询页面,直接调用MAXIMO API脚本
```
select
    MAXPROP.ACCESSTYPE, MAXPROP.CHANGEBY, MAXPROP.CHANGEDATE, MAXPROP.DESCRIPTION, MAXPROP.DOMAINID, MAXPROP.ENCRYPTED, MAXPROP.GLOBALONLY, MAXPROP.INSTANCEONLY,
MAXPROP.LIVEREFRESH, MAXPROP.MASKED, MAXPROP.MAXIMODEFAULT, MAXPROP.MAXPROPID, MAXPROP.MAXTYPE, MAXPROP.NULLSALLOWED, MAXPROP.ONLINECHANGES,
MAXPROP.PROPNAME, MAXPROP.SECURELEVEL, MAXPROP.USERDEFINED, MAXPROP.VALUERULES,
       MAXPROPVALUE.ACCESSTYPE,
MAXPROPVALUE.CHANGEBY,
MAXPROPVALUE.CHANGEDATE,
MAXPROPVALUE.ENCRYPTEDVALUE,
MAXPROPVALUE.MAXPROPVALUEID,
MAXPROPVALUE.PROPNAME,
MAXPROPVALUE.PROPVALUE,
MAXPROPVALUE.SERVERHOST,
MAXPROPVALUE.SERVERNAME
from maxprop
left join maxpropvalue on (maxprop.PROPNAME=maxpropvalue.PROPNAME)
```


接口脚本 E:/gitwork/wushiling/jsproject/masscript/cn/shoukaiseki/tools/SKS_MAXPROP_MANAGE.js
